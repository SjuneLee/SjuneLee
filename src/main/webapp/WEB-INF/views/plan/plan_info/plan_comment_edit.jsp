...
<form id="plan_comment_edit_form" method="post" 
	action="${pageContext.request.contextPath}/plan/plan_info/plan_comment_edit_ok.do">
	<!-- 삭제 대상에 대한 상태유지 -->
	<input type="hidden" name="comment_id" value="${comment.id}" />
	<input type="hidden" name="travelPlanId" value="${comment.travelPlanId}" />
