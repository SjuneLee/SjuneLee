...
<body>
	<div class="container">
					...
					<td>
						<c:choose>
							<c:when test="${prevNotice != null}">
								<c:url var="prevUrl" value="/admin/admin_notice_read.do">
					...
					<td>
						<c:choose>
							<c:when test="${nextNotice != null}">
								<c:url var="nextUrl" value="/admin/admin_notice_read.do">
		...
		<div class="text-center" style="padding: 80px 0px">
			...
			<a href="${pageContext.request.contextPath}/admin/admin_notice_edit.do?customer_center_id=${readNotice.id}"
			class="btn btn-warning">수정</a>
			<a href="${pageContext.request.contextPath}/admin/admin_notice_delete_ok.do?customer_center_id=${readNotice.id}" 
