...
<body>
	...
	<div class="container" style="padding: 40px 50px;">
		...
		<ul class="nav nav-tabs nav-justified">
			<li class="active"><a
				href="${pageContext.request.contextPath}/service/service_center.do">공지사항</a></li>
			<li><a
				href="${pageContext.request.contextPath}/service/service_center_qna.do">질문답변</a></li>
		</ul>
	</div>
	...
	<div class=container style="padding: 0px 50px;">
				...
				<ul class="pagination">
					...
					<c:choose>
						<c:when test="${pageHelper.prevPage > 0}">
							...
							<c:url var="prevUrl" value="/service/notice.do">
					...
					<c:forEach var="i" begin="${pageHelper.startPage}"
						...
						<c:url var="pageUrl" value="/service/notice.do">
							<c:param name="keyword" value="${keyword}"></c:param>
					...
					<c:choose>
						<c:when test="${pageHelper.nextPage > 0}">
							...
							<c:url var="nextUrl" value="/service/notice.do">
								<c:param name="keyword" value="${keyword}"></c:param>
		...
		<form action="${pageContext.request.contextPath}/service/notice.do"
		method="get">
